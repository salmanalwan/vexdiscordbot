...
client.on('message', (message) => {
    ...
    if(command === prefix+'help'){
        ...
        .addField(config.prefix+'blackmarket', 'DMs you our Black-Market Server invite link.',true)
    ...
    if(command === prefix+'shop'){
        ...
        .setColor(0x23272A)
        .setTitle('Go To #『🔔』vxdom-shop『🔔』 To See vxdom shop {shop updated every one week }')
        return message.channel.send(embed);
    ...
    if(command === prefix+'blackmarket'){
        let adv = new Discord.RichEmbed()
            .setAuthor('|>Black Market<|', 'https://imgur.com/PuDorZs.png')
            .setColor(0xFF0000)
            .setTitle('Click Here to Join now !')
            .setURL('https://discord.gg/KYs5tZV')
            .setThumbnail('https://imgur.com/JfjGWIv.gif')
            .setImage('https://imgur.com/SIhmcAy.jpg')
            .setTimestamp()
